...
Mesh GenMeshCubicmapMulticolor(Image cubicmap, Vector3 cubeSize, Color floorColor, Color emptyColor)
{
    ...
    RectangleF wrongTexUV = {sideWidth * 2.0f, 0.5f, sideWidth, 0.5f};

    for (int z = 0; z < cubicmap.height; ++z)
    {
        for (int x = 0; x < cubicmap.width; ++x)
        {
            // no reason to generate objects for empty areas
            Color pixelColor = pixels[z*cubicmap.width + x];
            if (COLOR_EQUAL(pixelColor, emptyColor)) continue;
            ...
            if (COLOR_EQUAL(pixels[z*cubicmap.width + x], CDARKRED))
            {
                ...
                if (((z < cubicmap.height - 1) && COLOR_EQUAL(pixels[(z + 1)*cubicmap.width + x], floorColor)) || (z == cubicmap.height - 1))
                {
                    ...
                    mapTexcoords[tcCounter] = (Vector2){ victoryTexUV.x, victoryTexUV.y };
                    mapTexcoords[tcCounter + 1] = (Vector2){ victoryTexUV.x, victoryTexUV.y + victoryTexUV.height };
                    mapTexcoords[tcCounter + 2] = (Vector2){ victoryTexUV.x + victoryTexUV.width, victoryTexUV.y };
                    mapTexcoords[tcCounter + 3] = (Vector2){ victoryTexUV.x + victoryTexUV.width, victoryTexUV.y };
                    mapTexcoords[tcCounter + 4] = (Vector2){ victoryTexUV.x, victoryTexUV.y + victoryTexUV.height };
                    mapTexcoords[tcCounter + 5] = (Vector2){ victoryTexUV.x + victoryTexUV.width, victoryTexUV.y + victoryTexUV.height };
                    tcCounter += 6;
                }
                ...
                if (((z > 0) && COLOR_EQUAL(pixels[(z - 1)*cubicmap.width + x], floorColor)) || (z == 0))
                {
                    ...
                    mapTexcoords[tcCounter] = (Vector2){ victoryTexUV.x + victoryTexUV.width, victoryTexUV.y };
                    mapTexcoords[tcCounter + 1] = (Vector2){ victoryTexUV.x, victoryTexUV.y + victoryTexUV.height };
                    mapTexcoords[tcCounter + 2] = (Vector2){ victoryTexUV.x + victoryTexUV.width, victoryTexUV.y + victoryTexUV.height };
                    mapTexcoords[tcCounter + 3] = (Vector2){ victoryTexUV.x + victoryTexUV.width, victoryTexUV.y };
                    mapTexcoords[tcCounter + 4] = (Vector2){ victoryTexUV.x, victoryTexUV.y };
                    mapTexcoords[tcCounter + 5] = (Vector2){ victoryTexUV.x, victoryTexUV.y + victoryTexUV.height };
                    tcCounter += 6;
                }
                ...
                if (((x > 0) && COLOR_EQUAL(pixels[z*cubicmap.width + (x - 1)], floorColor)) || (x == 0))
                {
                    ...
                    mapTexcoords[tcCounter] = (Vector2){ victoryTexUV.x, victoryTexUV.y };
                    mapTexcoords[tcCounter + 1] = (Vector2){ victoryTexUV.x + victoryTexUV.width, victoryTexUV.y + victoryTexUV.height };
                    mapTexcoords[tcCounter + 2] = (Vector2){ victoryTexUV.x + victoryTexUV.width, victoryTexUV.y };
                    mapTexcoords[tcCounter + 3] = (Vector2){ victoryTexUV.x, victoryTexUV.y };
                    mapTexcoords[tcCounter + 4] = (Vector2){ victoryTexUV.x, victoryTexUV.y + victoryTexUV.height };
                    mapTexcoords[tcCounter + 5] = (Vector2){ victoryTexUV.x + victoryTexUV.width, victoryTexUV.y + victoryTexUV.height };
                    tcCounter += 6;
                }
            }
            else if (COLOR_EQUAL(pixels[z*cubicmap.width + x], CORANGE))
            {
                // Define triangles and checking collateral cubes
                //------------------------------------------------
                ...
                if (((z < cubicmap.height - 1) && COLOR_EQUAL(pixels[(z + 1)*cubicmap.width + x], floorColor)) || (z == cubicmap.height - 1))
                {
                    ...
                    mapTexcoords[tcCounter] = (Vector2){ wrongTexUV.x, wrongTexUV.y };
                    mapTexcoords[tcCounter + 1] = (Vector2){ wrongTexUV.x, wrongTexUV.y + wrongTexUV.height };
                    mapTexcoords[tcCounter + 2] = (Vector2){ wrongTexUV.x + wrongTexUV.width, wrongTexUV.y };
                    mapTexcoords[tcCounter + 3] = (Vector2){ wrongTexUV.x + wrongTexUV.width, wrongTexUV.y };
                    mapTexcoords[tcCounter + 4] = (Vector2){ wrongTexUV.x, wrongTexUV.y + wrongTexUV.height };
                    mapTexcoords[tcCounter + 5] = (Vector2){ wrongTexUV.x + wrongTexUV.width, wrongTexUV.y + wrongTexUV.height };
                    tcCounter += 6;
                }
                ...
                if (((z > 0) && COLOR_EQUAL(pixels[(z - 1)*cubicmap.width + x], floorColor)) || (z == 0))
                {
                    ...
                    mapTexcoords[tcCounter] = (Vector2){ wrongTexUV.x + wrongTexUV.width, wrongTexUV.y };
                    mapTexcoords[tcCounter + 1] = (Vector2){ wrongTexUV.x, wrongTexUV.y + wrongTexUV.height };
                    mapTexcoords[tcCounter + 2] = (Vector2){ wrongTexUV.x + wrongTexUV.width, wrongTexUV.y + wrongTexUV.height };
                    mapTexcoords[tcCounter + 3] = (Vector2){ wrongTexUV.x + wrongTexUV.width, wrongTexUV.y };
                    mapTexcoords[tcCounter + 4] = (Vector2){ wrongTexUV.x, wrongTexUV.y };
                    mapTexcoords[tcCounter + 5] = (Vector2){ wrongTexUV.x, wrongTexUV.y + wrongTexUV.height };
                    tcCounter += 6;
                }
                ...
                if (((x > 0) && COLOR_EQUAL(pixels[z*cubicmap.width + (x - 1)], floorColor)) || (x == 0))
                {
                    ...
                    mapTexcoords[tcCounter] = (Vector2){ wrongTexUV.x, wrongTexUV.y };
                    mapTexcoords[tcCounter + 1] = (Vector2){ wrongTexUV.x + wrongTexUV.width, wrongTexUV.y + wrongTexUV.height };
                    mapTexcoords[tcCounter + 2] = (Vector2){ wrongTexUV.x + wrongTexUV.width, wrongTexUV.y };
                    mapTexcoords[tcCounter + 3] = (Vector2){ wrongTexUV.x, wrongTexUV.y };
                    mapTexcoords[tcCounter + 4] = (Vector2){ wrongTexUV.x, wrongTexUV.y + wrongTexUV.height };
                    mapTexcoords[tcCounter + 5] = (Vector2){ wrongTexUV.x + wrongTexUV.width, wrongTexUV.y + wrongTexUV.height };
                    tcCounter += 6;
                }
            ...
            // We check pixel color not to be floor color -> draw full cube
            else if (!COLOR_EQUAL(pixels[z*cubicmap.width + x], floorColor))
            {
                // Define triangles and checking collateral cubes
                //------------------------------------------------
            ...
            // We check pixel color to be floorColor, we will only draw floor and roof
            else if (COLOR_EQUAL(pixels[z*cubicmap.width + x], floorColor))
            {
                // Define top triangles (2 tris, 6 vertex --> v1-v2-v3, v1-v3-v4)
                mapVertices[vCounter] = v1;
